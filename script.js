...
// ==========================================================
// BUILD PROFESSIONAL COMPLIANCE UI
// ==========================================================

function renderAgentCompliance(agent) {

  const oldCompliance =
    document.querySelector(".profile-compliance");

  if (!oldCompliance) return;

  oldCompliance.className =
    "profile-compliance compliance-pro";

  oldCompliance.innerHTML = `

    <div class="compliance-pro-heading">

      <span class="compliance-heading-icon">
        <svg
          viewBox="0 0 24 24"
          width="18"
          height="18"
    ...
    <div class="compliance-pro-grid">


      <!-- RESIDENT LICENSE -->

      <div class="compliance-pro-card">

        <div class="compliance-pro-icon">
        ...
        <div class="compliance-pro-content">
          <span>Resident License</span>

          <strong id="profileResidentLicense">
